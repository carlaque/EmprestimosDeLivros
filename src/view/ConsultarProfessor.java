...
public class ConsultarProfessor extends JFrame {
	 ...
	 * Create the frame.
	 */
	public ConsultarProfessor( final Professores professores) {
		...
		JLabel lblCodigoLeitor = new JLabel("Codigo professor:");
		...
		JLabel lbltitulo = new JLabel("Consultar Professor");
				...
				if(!txtCodigoLivro.getText().equals("")) {
					try {
						...
						JOptionPane.showMessageDialog(null,
							    "O codigo de um Professor sempre é um numero.",
							    "Consultar",
					...
					novo = (Professor) professores.buscaPeloCodigo(cod);
					
					if(novo != null) {
						txtDoc.setText(novo.getCpf());
						...
						JOptionPane.showMessageDialog(null,
							    "O codigo de Professor invalido, tente outro.",
							    "Consultar",
							    JOptionPane.ERROR_MESSAGE);
						txtDoc.setText("");
						txtTelefone.setText("");
